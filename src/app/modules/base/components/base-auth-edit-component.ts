  ...
  Submit(): void {
    if (this.isNew) {
      this.SubmitNew().subscribe((data: any) => {
        ...
        this.Alert.showSuccess(this.Translate.translate.instant('Data.AddSuccess'));
        this.Redirect();
      }, error => {
        this.Alert.showError(this.Translate.translate.instant('Data.AddError'));
      });
    }
    else {
      this.SubmitUpdate().subscribe((data: any) => {
        this.Alert.showSuccess(this.Translate.translate.instant('Data.UpdateSuccess'));
        this.Redirect();
      }, error => {
        this.Alert.showError(this.Translate.translate.instant('Data.UpdateError'));
      });
    }
  }
